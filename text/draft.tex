...
morphological duplicates such as ``Gene,'' ``gene,'' " gene``,''/gene``.
Also, some keywords are in fact keyword chains, for
example''Dendrites/metabolism/ultrastructure". Keyword chains must be
broken into their component keywords and then parsed again. The reason
for this is that Annif only assigns flat keywords and not keyword
chains.
