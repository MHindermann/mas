...
as \texttt{/keywords/operation\_history.json}. First
\texttt{keywords/keywords\_clean\_histogram.json} was set as a new
project in OpenRefine. The \texttt{keyword} column was then duplicated
and reconciled with Wikidata. Here the parameters were chosen as
follows: reconcile against no particular type, and auto-match candidates
